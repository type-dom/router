...
export function createRouterMatcher(
  ...
  function addRoute(
    ...
    // console.warn('addRoute . ');
    // used later on to remove by name
    const isRootAdd = !originalRecord;
    const mainNormalizedRecord = normalizeRouteRecord(record);
    // console.warn('mainNormalizedRecord is ', mainNormalizedRecord);
    // if (__DEV__) {
  ...
  function removeRoute(
    ...
    // console.warn('removeRoute . matcherRef is ', matcherRef);
  ...
  function resolve(
    ...
    if ('name' in location && location.name) {
      ...
      // console.error('matcher  location is ', location)
      params = assign(
        {},
        currentLocation.params,
        (
          location as
            | Readonly<MatcherLocationAsName>
            | Readonly<MatcherLocationAsRelative>
        ).params
      );
      path = matcher.stringify(params);
    }
...
export function normalizeRouteRecord(
  ...
  // console.warn('normalizedRouteRecord . ');

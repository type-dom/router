...
export type {
  ...
  UseLinkOptions,
  UseLinkReturn,
} from './router-link/router-link.interface';
export {
  RouterLink,
  //   _RouterLinkI,
} from './router-link/router-link.class';
export { useLink } from './router-link/utils';
...
export type { RouterViewProps } from './router-view/router-view.interface';

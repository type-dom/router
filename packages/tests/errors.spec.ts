...
import { createRouter as newRouter, createMemoryHistory } from '../../nx-workspace/libs/router'
import {
  NavigationFailure,
  ...
  createRouterError,
  ErrorTypes,
} from '../../nx-workspace/libs/router/src/errors'
import { components, tick } from './utils'
import type { RouteRecordRaw, NavigationGuard } from '../../nx-workspace/libs/router'
import type {
  RouteLocationRaw,
  RouteLocationNormalized,
} from '../../nx-workspace/libs/router/src/typed-routes'
import { START_LOCATION_NORMALIZED } from '../../nx-workspace/libs/router/src/location'
